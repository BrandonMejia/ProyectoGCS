...
class CentroSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $centro01->direccion = "https://goo.gl/maps/TqreNA5uWsyzBJ3K6";
        ...
        $centro02->direccion = "https://goo.gl/maps/4EVa6LaQKJayCmqq7";
        ...
        $centro03->direccion = "https://goo.gl/maps/uDNnmdeHSuqa39tf8";
        ...
        $centro04->direccion = "https://goo.gl/maps/VozpG9g9fY5akRun7";
        ...
        $centro05->direccion = "https://goo.gl/maps/uDNnmdeHSuqa39tf8";
        ...
        $centro06->direccion = "https://goo.gl/maps/cTfewjntDTcq9tsPA";
        ...
        $centro07->direccion = "https://goo.gl/maps/udvN1tuiShESHfcD8";
        ...
        $centro08->direccion = "https://goo.gl/maps/AoyErRgMZf8MVruM9";
        ...
        $centro09->direccion = "https://goo.gl/maps/wmuBpn7VL17ahYKM7";
        ...
        $centro10->direccion = "https://goo.gl/maps/kJhQAsUet5hjgMX59";
        ...
        $centro11->direccion = "https://goo.gl/maps/uxvMUpUPBmc17gvK8";
        ...
        $centro12->direccion = "https://goo.gl/maps/a6FSkmWZGAbeMaaG7";
        ...
        $centro13->direccion = "https://goo.gl/maps/EZTd6ivbN7Kamqpx8";
        ...
        $centro14->direccion = "https://goo.gl/maps/Rn6Gyqfk9RD8xymr5";
        ...
        $centro15->direccion = "https://goo.gl/maps/1BfnMRsn3A3nQUsU7";
        ...
        $centro16->direccion = "https://goo.gl/maps/8EFHch2y3DNN2KSu9";
        ...
        $centro17->direccion = "https://goo.gl/maps/bqyp9bJ1TzUQAvKU7";
        ...
        $centro18->direccion = "https://goo.gl/maps/w8LDWHbvkj1vrTqw7";
        $centro18->capacidad = 50;
        $centro18->distrito_id = 49;

        $centro19 = new Centro();
        $centro19->nombre = "Centro de Salud San Cristobal";
        $centro19->direccion = "https://goo.gl/maps/Nidmm14bFLyGwsTu6";
        ...
        $centro20->direccion = "https://goo.gl/maps/jUE7fSgzkRCfBZ8s6";
        ...
        $centro21->direccion = "https://goo.gl/maps/SeJ3BSTZZ5ni1FYG9";
        ...
        $centro22->direccion = "https://goo.gl/maps/f57WyhGhn6qDAvUw7";
        ...
        $centro23->direccion = "https://goo.gl/maps/yPBYDbdJ9moJfg817";
        ...
        $centro24->direccion = "https://goo.gl/maps/HuHczM4MSuAgNwvi7";
        ...
        $centro25->direccion = "https://goo.gl/maps/5PwtAntoW3ZwTjuu7";
        ...
        $centro26->direccion = "https://goo.gl/maps/6ABNfiMEsuaf6Yoa6";
        ...
        $centro27->direccion = "https://goo.gl/maps/PzYDARjMLXYVyUeg8";
        ...
        $centro28->direccion = "https://goo.gl/maps/PbFe6RbJ6piY3cpN7";
        ...
        $centro29->direccion = "https://goo.gl/maps/GEdUpxbapjbTrLE97";
        ...
        $centro30->direccion = "https://goo.gl/maps/LerUUNF5STz1C5B36";
        ...
        $centro31->direccion = "https://goo.gl/maps/tRmZSqms2JdKC62q8";
        ...
        $centro32->direccion = "https://goo.gl/maps/USKM2yAYowgdvWzt9";
        ...
        $centro33->direccion = "https://goo.gl/maps/5TV5qcpr5Fj5CBMN8";
